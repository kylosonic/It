...
const App: React.FC = () => {
  const [activeTab, setActiveTab] = useState<"all" | "diplomacy" | "meetings">(
    "all",
  );
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      >
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <div
              className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors ${isScrolled ? "bg-blue-600 text-white" : "bg-white text-blue-600"}`}
            >
              <i className="fa-solid fa-landmark"></i>
            </div>
            <span
              className={`font-bold tracking-tight ${isScrolled ? "text-gray-900" : "text-white"}`}
            >
              T. WOLDU
            </span>
          </div>
          <div
            className={`hidden md:flex gap-8 text-sm font-medium ${isScrolled ? "text-gray-600" : "text-white"}`}
          >
      ...
      <header
        id="home"
        className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gray-900 py-20"
      >
        <div className="absolute inset-0 z-0">
          <img
            src="photo_2026-02-10_21-43-47.jpg"
            alt="Background"
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 tracking-tight">
            ...
            <span className="text-blue-400">Temesgn Woldu</span>
          </h1>
          ...
          <div className="mt-12 flex flex-col items-center gap-6">
            ...
            <div className="relative group max-w-2xl w-full mx-auto">
              ...
              <img
                src="photo_2026-02-10_21-18-41.jpg"
          ...
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                <p>
                  As an <strong>International Delegate</strong> for the
                  Ethiopian Youth Council (EYC), Temesgn Woldu Gebremedhin
                  represents the voice of the Ethiopian youth on the global
                  stage. His presence at high-level summits demonstrates
                  Ethiopia's commitment to international dialogue and
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                    ...
                    <p className="text-xs">
                      Active participation in international forums with
                      representatives from Eswatini, Brazil, and more.
                    </p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                    ...
                    <p className="text-xs">
                      Strengthening relations through formal audiences with
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        Official National Delegate Organ
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto">
              Visual documentation of official diplomatic activities and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {filteredGallery.map((item) => (
              ...
              >
                ...
                <div className="p-6">
                  <span className="text-blue-600 text-xs font-bold uppercase tracking-widest mb-2 inline-block">
                    {item.category}
                  </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex justify-between py-3 border-b border-blue-700/50">
                    <span className="text-blue-300 text-sm uppercase font-semibold">
                      Reference ID
                    </span>
                    <span className="font-mono text-white">
                      {DELEGATE_DATA.idNumber}
                    </span>
                  </li>
                  <li className="flex justify-between py-3 border-b border-blue-700/50">
                    <span className="text-blue-300 text-sm uppercase font-semibold">
              ...
              <div className="flex flex-col justify-center text-center p-6 bg-blue-700/30 rounded-2xl">
                ...
                <p className="text-sm text-blue-200 leading-relaxed">
                  This identity card certifies Temesgn Woldu Gebremedhin as a
                  legitimate representative of the Ethiopian Youth Council. This
                  digital portfolio serves as a public verification of
                  credentials.
                </p>
              </div>
            </div>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
            <div className="max-w-sm">
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-6">
                Representing the future of Ethiopia through global engagement
          ...
          <div className="pt-8 border-t border-gray-100 text-center text-xs text-gray-400">
            <p>
              &copy; 2024 Temesgn Woldu Gebremedhin. Verified International
              Delegate Portfolio.
            </p>
          </div>
        </div>
